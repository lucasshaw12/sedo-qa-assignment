...
from .views import TicketListView, TicketCreateView, TicketUpdateView, TicketDeleteView, ticket_complete
...
urlpatterns = [
    ...
    path("<int:pk>/complete/", ticket_complete, name="ticket_complete"),
]
